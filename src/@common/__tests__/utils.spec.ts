...
describe('@common/utils', () => {
	...
	describe('formatPhone', () => {
		...
		it('удаление элементов в произвольном месте', () => {
			expect(formatPhone('7(9)555-22-11')).toBe('+7 (955) 522 - 11');
		});

		it('удаление элементов в произвольном месте, которые начинаются с неверного числа', () => {
			expect(formatPhone('555-22-11')).toBe('+7 (555) - 22 - 11');
		});

		it('еще вариант форматирования', () => {
			expect(formatPhone('5-22-1123123')).toBe('+7 (522) 112 - 31 - 23');
		});

		it('еще вариант форматирования буквы удаляются', () => {
			expect(formatPhone('афыfa5-22-1123123')).toBe('+7 (522) 112 - 31 - 23');
		});
	});
});
