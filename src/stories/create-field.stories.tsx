...
import FieldArraySelect from './field-array-select';
...
export const FieldArrayStringsSelect: ComponentStory<typeof Field> = ({
	onSubmit,
}: any) => {
	return (
		<>
			...
			<div className="shadow border border-secondary rounded-3 p-3 w-75">
				<Form<T3> onSubmit={onSubmit}>
					...
					<div className=" w-75">
						<FieldArraySelect<T3> name="variants" label="Выбор" />
					</div>
					<button className="btn btn-success" type="submit">
						Отправить
					</button>
